<template>
  <el-card shadow="never" class="card-box">
      ...
      <el-row :gutter="20">
        <el-col :sm="24" :md="12" :lg="8" :xl="6">
          <el-form-item label="字典名称">
            <el-input v-model="queryForm.name" clearable placeholder="请输入字典名称"/>
          </el-form-item>
        </el-col>
        <el-col :sm="24" :md="12" :lg="8" :xl="6">
          <el-form-item label="字典编码">
            <el-input v-model="queryForm.code" clearable placeholder="请输入字典编码"/>
          </el-form-item>
        </el-col>
        <el-col :sm="24" :md="12" :lg="8" :xl="6">
    ...
    <el-table :data="tableData.data" border style="width: 100%" row-key="id" default-expand-all>
      <el-table-column prop="name" label="字典名称" align="center" width="300"/>
      <el-table-column prop="code" label="字典编码" align="center" width="300"/>
...
import {deleteSysDic, getAllSysDicTreeList} from "@/api/dic";
...
// 获取表格列表
const getTableList = () => {
  getAllSysDicTreeList({...queryForm.value}).then(res => {
    tableData.data = res || [];
  })
}
/** 删除*/
