...
import TableForm from "@/views/station/stock/table-form.vue";
...
const openDialog = async (row: any = {}) => {
  ...
  const stockInfoData = await getStockInfoList(row.name);  // 使用实际的API函数获取数据
  tableDialogRef.value.updateData(stockInfoData);  // 更新子组件的数据
}
getTableList();
</script>
<style></style>
